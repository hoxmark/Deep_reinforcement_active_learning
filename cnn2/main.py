...
def main():
    ...
    lg = logger.Logger('./logs/cnn2/batch_size={},date={},FILTERS={},FILTER_NUM={},WORD_DIM={},MODEL={},DROPOUT_PROB={},NORM_LIMIT={},EVAL={},RESET={},SCORE_FN={},AVERAGE={}'.format(
        params["BATCH_SIZE"],
